...
export const Bot = (props: BotProps & { class?: string }) => {
    ...
    if (result.data) {
      ...
      if (typeof data === 'object' && data.text && data.sourceDocuments) {
        if (!isChatFlowAvailableToStream()) {
          setMessages((prevMessages) => [...prevMessages, { message: data.text, sourceDocuments: data.sourceDocuments, type: 'apiMessage' }]);
        }
      } else {
  ...
  createEffect(() => {
    ...
    console.log('Is Chat UI Visible:', isChatUiVisible());
  });
